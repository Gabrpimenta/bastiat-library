...
- Native navigation and artwork transitions now follow the system's Reduce Motion setting, including changes while the app runs. Web CSS already disables transitions, shimmer and smooth scrolling for reduced motion. Native setting toggles and screen-reader traversal remain pending manual validation.
